...
var RustTestCases = []RustTestCase{
	...
	// 	// nss::sign(&SignatureAlgorithm::ES256, pkcs8P256EE, payload)
	...
	// COSE sign/verify example usages.
	{
		...
		Certs:           [][]byte{p256root[:], p256int[:], RSAroot[:], RSAint[:]},
	...
	// {
	// 	// Doesn't check certs
	// 	Title: "test_cose_verify_xpiSignature",
	// 	SignPayload: []byte(""),
	// 	// test::setup();
	// 	// assert!(verify_signature(xpiPayload, test::xpiSignature.to_vec()).is_ok
	// },
