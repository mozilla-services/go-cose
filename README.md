...
See [example/sign/sign.go](example/sign/sign.go) and run it with:

```console
$ go run example/sign/sign.go
...
See [example/verify/verify.go](example/verify/verify.go) and run it with:

```console
$ go run example/verify/verify.go
